...
entirely open source and under the __Apache License 2.0__.
...
1. Propose changes in the game rules.
2. Debate the wisdom of changing them.
3. Vote.
...
Because the rules are always changing, there is no absolute set of rules to Nomic. There is only the starting or initial set of rules.

There are 29 numbered rules in the Initial Set.

* 101 to 116 -> Immutable Rules
* 201 to 213 -> Mutable Rules
...
http://legacy.earlham.edu/~peters/writing/nomic.htm#213
